        ...
        <div className="flex items-center col-span-7">
          <div className="w-[480px] h-fit mx-auto">
            <div className="top-50%">
              ...
              <button
                type="button"
                className="text-[#1A1C1E] w-full border border-solid border-1 border-[#E0E0E0] hover:bg-[#f0f1f0] font-medium rounded-lg text-sm py-2.5 text-center flex items-center mx-auto my-4 duration-100"
              >
